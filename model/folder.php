...
function display_folders(){
    ...
    while ($donnees = $req->fetch()){
        ...
        $select = $select . '</select>';
            ...
            $files = $files . '<div class="folder"><div class="folder_info">' . $donnees['foldername'] . '<form action="index.php?action=deletefolder" method="post" enctype="multipart/form-data"><input class="hidden" required type="text" 
        value="'.$donnees['folderpath'].'"name="foldertodelete"><label for="'.$donnees['folderpath'].'"><img class="trash" src="assets/remove_task.png" alt="trash"></label><input id="'.$donnees['folderpath'].'" class="hidden" type="submit" value="Supprimer"></form><form action="index.php?action=renamefolder" method="post" enctype="multipart/form-data"><input class="hidden" required type="text" value="'.$donnees['foldername'].'"name="foldertorename" class="foldertomove"><input type="text" name="newfoldername" placeholder="Entrez un nouveau nom"><br><input type="submit" value="Renommer"></form><form action=?action=movefolder method="post" enctype="multipart/form-data"><input class="hidden" required type="text" value="'.$donnees['folderpath'].'"name="foldertomove" id="filetodelete">'. $select .'<input type="submit" value="Deplacer le dossier"/></form></div><div class="folder_files">';
        ...
        while($folderinfolder = $requ->fetch()){
            ...
            $select = $select . '</select>';
                        ...
                        $files = $files . '<div class="folder"><div class="folder_info">' . $folderinfolder['foldername'] . '<form action="index.php?action=deletefolder" method="post" enctype="multipart/form-data"><input class="hidden" required type="text" 
        value="'.$folderinfolder['folderpath'].'"name="foldertodelete"><label for="'.$folderinfolder['folderpath'].'"><img class="trash" src="assets/remove_task.png" alt="trash"></label><input id="'.$folderinfolder['folderpath'].'" class="hidden" type="submit" value="Supprimer"></form><form action="index.php?action=renamefolder" method="post" enctype="multipart/form-data"><input class="hidden" required type="text" value="'.$folderinfolder['foldername'].'"name="foldertorename" class="foldertomove"><input type="text" name="newfoldername" placeholder="Entrez un nouveau nom"><br><input type="submit" value="Renommer"></form><form action=?action=movefolder method="post" enctype="multipart/form-data"><input class="hidden" required type="text" value="'.$folderinfolder['folderpath'].'"name="foldertomove" id="filetodelete">'. $select .'<input type="submit" value="Deplacer le dossier"/></form></div><div class="folder_files">';
